...
🧩 _Concepts:_ Interfaces, Arrays, DOM rendering.
...
🧩 _Concepts:_ Interface inheritance, optional properties.
...
🧩 _Concepts:_ Function interfaces and type signatures.
...
🧩 _Concepts:_ Classes, method typing, constructor interfaces.
...
🧩 _Concepts:_ Interfaces, class implementation, union types.
...
🧩 _Concepts:_ Type narrowing, discriminated unions, runtime checking.
...
🧩 _Concepts:_ String literal types, type-safe conditionals.
...
🧩 _Concepts:_ Ambient declarations, `.d.ts` files, third-party typings.
...
🧩 _Concepts:_ Namespaces, declaration merging, inheritance.
...
🧩 _Concepts:_ Namespaced imports, class composition.
...
Implements _nominal typing_ via branded interfaces.
...
🧩 _Concepts:_ Nominal typing, brand patterns, type safety.
